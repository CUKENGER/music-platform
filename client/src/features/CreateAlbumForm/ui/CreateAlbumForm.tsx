import { AddTrackIcon, PrivateRoutes } from '@/shared';
import { useCreateAlbumForm } from '../model/useCreateAlbumForm';
import styles from './CreateAlbumForm.module.scss'
import { AlbumCommonForm, AlbumCoverInput, MainInfoInputs, MultipleInputAudio, TrackFormList } from '@/entities';
