...
import { useAddLikeTrack, useDeleteLikeTrack, useGetOneTrack, usePlayerStore, useUserStore } from "@/entities";
...
export const TrackLikeContainer: FC<TrackLikeContainerProps> = ({ id, likes }) => {
  ...
  const handleLike = useCallback((e: React.MouseEvent<HTMLDivElement, MouseEvent> ) => {
    e.stopPropagation()
    if (!id) return;
